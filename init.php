...
$quest_flag = 0; // 直接 質問ページへ（デバッグ用）
$debug_mode = 0; // デバッグフラグ
// クラウドソーシングの完了文字列
// $pwd = 'kH5#x@3s';
...
<center><img border="1" src="./image/ui-screenshot.png" width="700" alt="snapshoot"></center>
<p>
...
$toi_explanation = '
  <p>
　左に表示された胸部単純X線写真について，結節状陰影の読影を行って下さい．<br>
